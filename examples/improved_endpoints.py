...
from py_vector.models.responses import (
    BaseResponse,
...
from py_vector.utils.response_helper import ResponseHelper
...
async def list_documents_improved(
    ...
    try:
        ...
        return ResponseHelper.success(data=documents, message="获取文档列表成功")
    except Exception as e:
        return ResponseHelper.internal_error(f"获取文档列表失败: {str(e)}")


# 示例2: 使用分页响应
@router.get("/documents/paginated", summary="获取分页文档列表")
...
async def get_document_details_improved(doc_id: str):
    ...
    try:
        ...
        return ResponseHelper.success(data=details, message="获取文档详情成功")
    except Exception as e:
...
async def upload_document_improved(
    ...
    try:
        ...
        return ResponseHelper.accepted(
            data=result, message="文档上传成功，正在后台处理"
        )
    except Exception as e:
...
# 示例5: 搜索响应
@router.post("/search", response_model=BaseResponse[SearchResponse], summary="搜索文档")
async def search_documents_improved(search_request: SearchRequest):
    ...
    try:
        ...
        return ResponseHelper.success(data=search_result, message="搜索完成")
    except Exception as e:
